...
void exposeDAMSoftContact1DAugmentedFwdDyn() {
  bp::register_ptr_to_python<
      std::shared_ptr<DAMSoftContact1DAugmentedFwdDynamics>>();
  ...
  bp::class_<DAMSoftContact1DAugmentedFwdDynamics,
             bp::bases<DAMSoftContactAbstractAugmentedFwdDynamics>>(
      "DAMSoftContact1DAugmentedFwdDynamics",
      "Differential action model for 1D visco-elastic contact forward dynamics "
      ...
      .add_property(
          ...
          &DAMSoftContact1DAugmentedFwdDynamics::set_type, "1D mask type");

  bp::register_ptr_to_python<
      std::shared_ptr<DADSoftContact1DAugmentedFwdDynamics>>();

  bp::class_<DADSoftContact1DAugmentedFwdDynamics,
             bp::bases<DADSoftContactAbstractAugmentedFwdDynamics>>(
      ...
      .add_property(
          ...
          bp::make_getter(&DADSoftContact1DAugmentedFwdDynamics::da_df3d,
                          bp::return_internal_reference<>()),
          "Partial derivative of LOCAL contact frame acceleration w.r.t. 3D "
          "contact force")
      .add_property("f3d",
      ...
      .add_property(
          ...
          bp::make_getter(&DADSoftContact1DAugmentedFwdDynamics::dfdt3d_dx,
                          bp::return_internal_reference<>()),
          "Partial derivative of the time derivative of the contact force (3D, "
          "LOCAL) w.r.t. state")
      .add_property(
          "dfdt3d_du",
