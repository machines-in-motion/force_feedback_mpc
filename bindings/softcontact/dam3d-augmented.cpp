...
void exposeDAMSoftContact3DAugmentedFwdDyn() {
  bp::register_ptr_to_python<
      std::shared_ptr<DAMSoftContact3DAugmentedFwdDynamics>>();
  ...
  bp::register_ptr_to_python<
      std::shared_ptr<DADSoftContact3DAugmentedFwdDynamics>>();
  ...
  bp::class_<DADSoftContact3DAugmentedFwdDynamics,
      ...
      .add_property(
          "tau_grav_residual",
          bp::make_getter(
              &DADSoftContact3DAugmentedFwdDynamics::tau_grav_residual,
              bp::return_internal_reference<>()),
