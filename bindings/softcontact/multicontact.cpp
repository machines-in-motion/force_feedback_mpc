...
np::ndarray eigenToNumpy(const Matrix& matrix) {
  ...
  std::copy(matrix.data(), matrix.data() + matrix.size(),
            reinterpret_cast<typename Matrix::Scalar*>(result.get_data()));
  return result;
}
...
Matrix numpyToEigen(const np::ndarray& array) {
  ...
  std::copy(reinterpret_cast<typename Matrix::Scalar*>(array.get_data()),
            reinterpret_cast<typename Matrix::Scalar*>(array.get_data()) +
                matrix.size(),
            matrix.data());
  return matrix;
}
...
pinocchio::Force numpyToForce(const np::ndarray& array) {
  Eigen::Matrix<double, 6, 1> v =
      numpyToEigen<Eigen::Matrix<double, 6, 1>>(array);
...
BOOST_PYTHON_MODULE(viscoelastic_contact) {
  ...
  bp::class_<ViscoElasticContact3D, std::shared_ptr<ViscoElasticContact3D>>(
      "ViscoElasticContact3D",
      bp::init<pinocchio::Model&, pinocchio::FrameIndex, const Eigen::Vector3d&,
               double, double, pinocchio::ReferenceFrame>(
          (bp::arg("model"), bp::arg("frameId"),
           bp::arg("oPc") = Eigen::Vector3d::Zero(), bp::arg("Kp") = 10.0,
           bp::arg("Kv") = 0.0,
           bp::arg("pinRef") = pinocchio::LOCAL_WORLD_ALIGNED)))
      .def("calc", &ViscoElasticContact3D::calc,
           (bp::arg("data"), bp::arg("f")))
      .def("calc_fdot", &ViscoElasticContact3D::calc_fdot, bp::arg("data"))
      .def("update_ABAderivatives",
           &ViscoElasticContact3D::update_ABAderivatives,
           (bp::arg("data"), bp::arg("f")))
      ...
      .def("get_dfdt_dx", &ViscoElasticContact3D::get_dfdt_dx,
           bp::return_value_policy<bp::reference_existing_object>())
      .def("get_dfdt_du", &ViscoElasticContact3D::get_dfdt_du,
           bp::return_value_policy<bp::reference_existing_object>())
      .def("get_dfdt_df", &ViscoElasticContact3D::get_dfdt_df,
           bp::return_value_policy<bp::reference_existing_object>())
      .def("get_dABA_df", &ViscoElasticContact3D::get_dABA_df,
           bp::return_value_policy<bp::reference_existing_object>());

  // ViscoElasticContact3dMultiple
  bp::class_<ViscoElasticContact3dMultiple,
             std::shared_ptr<ViscoElasticContact3dMultiple>>(
      "ViscoElasticContact3dMultiple",
      bp::init<pinocchio::Model&,
               const std::vector<std::shared_ptr<ViscoElasticContact3D>>&>(
          (bp::arg("model"), bp::arg("contacts"))))
      .def("calc", &ViscoElasticContact3dMultiple::calc,
           (bp::arg("data"), bp::arg("f")))
      .def("calc_fdot", &ViscoElasticContact3dMultiple::calc_fdot,
           bp::arg("data"))
      .def("update_ABAderivatives",
           &ViscoElasticContact3dMultiple::update_ABAderivatives,
           (bp::arg("data"), bp::arg("f")))
      .def("calcDiff", &ViscoElasticContact3dMultiple::calcDiff,
           bp::arg("data"))
  ...
  bp::class_<FrictionConeConstraint, std::shared_ptr<FrictionConeConstraint>>(
      "FrictionConeConstraint", bp::init<pinocchio::FrameIndex, double>(
                                    (bp::arg("frameId"), bp::arg("coef"))))
  ...
  // ForceBoxConstraint
  bp::class_<ForceBoxConstraint, std::shared_ptr<ForceBoxConstraint>>(
      "ForceBoxConstraint",
      bp::init<pinocchio::FrameIndex, const Eigen::Vector3d&,
      ...
      .def("getLowerBound", &ForceBoxConstraint::getLowerBound,
           bp::return_value_policy<bp::reference_existing_object>())
      .def("getUpperBound", &ForceBoxConstraint::getUpperBound,
           bp::return_value_policy<bp::reference_existing_object>());
  ...
  // ForceConstraintManager
    ...
    // ForceCost
    bp::class_<ForceCost, std::shared_ptr<ForceCost>>(
        "ForceCost", bp::init<pinocchio::Model&, pinocchio::FrameIndex,
                              const Eigen::Vector3d&, const Eigen::Matrix3d&,
                              pinocchio::ReferenceFrame>((
                         bp::arg("model"), bp::arg("frameId"), bp::arg("f_des"),
                         bp::arg("f_weight"), bp::arg("pinRef"))))
        .def("calc", &ForceCost::calc,
             (bp::arg("data"), bp::arg("f"), bp::arg("pinRefDyn")))
        .def("calcDiff", &ForceCost::calcDiff,
             (bp::arg("data"), bp::arg("f"), bp::arg("pinRefDyn")))
        .def("getFrameId", &ForceCost::getFrameId);

    // ForceCostManager
    bp::class_<ForceCostManager, std::shared_ptr<ForceCostManager>>(
        "ForceCostManager",
        bp::init<const std::vector<std::shared_ptr<ForceCost>>&,
                 const std::shared_ptr<ViscoElasticContact3dMultiple>&>(
            (bp::arg("forceCosts"), bp::arg("contacts"))))
        .def("calc", &ForceCostManager::calc, (bp::arg("data"), bp::arg("f")))
        .def("calcDiff", &ForceCostManager::calcDiff,
             (bp::arg("data"), bp::arg("f")));
    ...
    bp::converter::registry::push_back(&numpyToEigen<Eigen::Vector3d>,
                                       bp::type_id<Eigen::Vector3d>());
    bp::converter::registry::push_back(&numpyToEigen<Eigen::Matrix3d>,
                                       bp::type_id<Eigen::Matrix3d>());
    bp::converter::registry::push_back(&numpyToEigen<Eigen::MatrixXd>,
                                       bp::type_id<Eigen::MatrixXd>());
    bp::converter::registry::push_back(
        &listToForceVector, bp::type_id<std::vector<pinocchio::Force>>());
}
