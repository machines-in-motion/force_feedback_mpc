...
void exposeDAMSoftContact1DFwdDyn() {
  bp::register_ptr_to_python<
      std::shared_ptr<DifferentialActionModelSoftContact1DFwdDynamics>>();
  ...
  bp::class_<DifferentialActionModelSoftContact1DFwdDynamics,
      ...
      bp::init<std::shared_ptr<crocoddyl::StateMultibody>,
               ...
               double, double, Eigen::Vector3d, pinocchio::ReferenceFrame,
               sobec::Vector3MaskType>(
      ...
      .def<void (DifferentialActionModelSoftContact1DFwdDynamics::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff",
          &DifferentialActionModelSoftContact1DFwdDynamics::calcDiff,
          bp::args("self", "data", "x", "u"),
          ...
          ":param data: soft contact 1d differential forward-dynamics action "
          "data\n"
      ...
      .def<void (DifferentialActionModelSoftContact1DFwdDynamics::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData",
           &DifferentialActionModelSoftContact1DFwdDynamics::createData,
           bp::args("self"), "Create the Euler integrator data.")
      .def("set_force_cost",
           &DifferentialActionModelSoftContact1DFwdDynamics::set_force_cost,
           bp::args("self", "force_des", "force_weight"),
           "Initialize force reference and cost weight ")
      .add_property(
          "Kp",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_Kp,
      ...
      .add_property(
          "Kv",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_Kv,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "oPc",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_oPc,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "f_des",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_force_des,
              bp::return_value_policy<bp::return_by_value>()),
          &DifferentialActionModelSoftContact1DFwdDynamics::set_force_des,
          "Desired force in the cost")
      .add_property(
          "f_weight",
          bp::make_function(&DifferentialActionModelSoftContact1DFwdDynamics::
                                get_force_weight,
                            bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "ref",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_ref,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "id",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_id,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "type",
          bp::make_function(
              &DifferentialActionModelSoftContact1DFwdDynamics::get_type,
              bp::return_value_policy<bp::return_by_value>()),
          &DifferentialActionModelSoftContact1DFwdDynamics::set_type,
          "Contact 1D mask type");

  bp::register_ptr_to_python<
      std::shared_ptr<DifferentialActionDataSoftContact1DFwdDynamics>>();

  bp::class_<DifferentialActionDataSoftContact1DFwdDynamics,
             bp::bases<crocoddyl::DifferentialActionDataFreeFwdDynamics>>(
      "DifferentialActionDataSoftContact1DFwdDynamics",
      "Action data for the soft contact 1D forward dynamics system",
      ...
      .add_property(
          "lJ",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::lJ,
              bp::return_internal_reference<>()),
          "Jacobian of the contact frame in LOCAL")
      .add_property(
          "oJ",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::oJ,
              bp::return_internal_reference<>()),
          "Jacobian of the contact frame in LOCAL_WORLD_ALIGNED")
      .add_property("lv_partial_dq",
                    bp::make_getter(
                        &sobec::DifferentialActionDataSoftContact1DFwdDynamics::
                            lv_partial_dq,
                        bp::return_internal_reference<>()),
      ...
      .add_property(
          "aba_dq",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::aba_dq,
              bp::return_internal_reference<>()),
          "Partial derivative of joint acceleration w.r.t. joint positions")
      .add_property(
          "aba_dv",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::aba_dv,
              bp::return_internal_reference<>()),
          "Partial derivative of joint accelerations w.r.t. joint velocities")
      .add_property(
          "aba_dtau",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::aba_dtau,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "f3d",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::f3d,
              bp::return_internal_reference<>()),
          "3D contact force")
      .add_property(
          "fLOCAL",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::fLOCAL,
              bp::return_internal_reference<>()),
          "Projection of the 1D contact force onto 3D LOCAL coordinates")
      .add_property(
          "fWORLD",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::fWORLD,
              bp::return_internal_reference<>()),
          "Projection of the 1D contact force onto 3D WORLD coordinates")
      .add_property(
          "df3d_dx",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::df3d_dx,
              bp::return_internal_reference<>()),
          "Partial derivative of 3D contact force w.r.t. state")
      .add_property(
          "df_dx",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::df_dx,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "pinForce",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::pinForce,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "fext",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::fext,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "fext_copy",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact1DFwdDynamics::fext_copy,
              bp::return_internal_reference<>()),
          "Vector of spatial wrenches due to visco-elastic contact, expressed "
