...
#ifndef FORCE_FEEDBACK_MPC_STATEJERK_HPP_
#define FORCE_FEEDBACK_MPC_STATEJERK_HPP_
...
class StateJerk : public crocoddyl::StateAbstract {
 public:
  ...
  explicit StateJerk(boost::shared_ptr<pinocchio::ModelTpl<double> > model,
                       std::vector<int> StateJerk_joint_ids,
                       std::size_t nc);
  virtual ~StateJerk();
...
#endif  // FORCE_FEEDBACK_MPC_STATEJERK_HPP_
