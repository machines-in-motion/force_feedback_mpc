...
class DifferentialActionModelSoftContact1DFwdDynamicsTpl
 ...
 public:
  ...
  DifferentialActionModelSoftContact1DFwdDynamicsTpl(
      ...
      const double Kp, const double Kv, const Vector3s& oPc,
...
template <typename _Scalar>
struct DifferentialActionDataSoftContact1DFwdDynamicsTpl
  ...
  explicit DifferentialActionDataSoftContact1DFwdDynamicsTpl(
