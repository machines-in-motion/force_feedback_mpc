...
/**
 * @brief Differential action model for 1D visco-elastic contact forward
 * dynamics in multibody systems (augmented dynamics including contact force as
 * a state)
 *
...
class DAMSoftContact1DAugmentedFwdDynamics
 ...
 public:
  ...
  virtual std::shared_ptr<crocoddyl::DifferentialActionModelBase> cloneAsFloat()
      const {
    return std::make_shared<DAMSoftContact1DAugmentedFwdDynamics>(*this);
  }
