...
#include "common.hpp"
#include "factory/state-soft.hpp"
...
void test_state_dimension(StateSoftContactModelTypes::Type state_type,
  ...
  const std::shared_ptr<force_feedback_mpc::softcontact::StateSoftContact>&
      state = factory.create(state_type, nc);
...
void test_state_dimension_0(StateSoftContactModelTypes::Type state_type) {
  ...
  const std::shared_ptr<force_feedback_mpc::softcontact::StateSoftContact>&
      state0 = factory.create(state_type, 0);
