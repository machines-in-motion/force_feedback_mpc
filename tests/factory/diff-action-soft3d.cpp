...
const std::vector<DAMSoftContact3DTypes::Type> DAMSoftContact3DTypes::all(
    DAMSoftContact3DTypes::init_all());

std::ostream& operator<<(std::ostream& os,
                         DAMSoftContact3DTypes::Type dam_type) {
  switch (dam_type) {
    case DAMSoftContact3DTypes::DAMSoftContact3DAugmentedFwdDynamics_TalosArm:
      os << "DAMSoftContact3DAugmentedFwdDynamics_TalosArm";
      break;
    case DAMSoftContact3DTypes::DAMSoftContact3DAugmentedFwdDynamics_HyQ:
    ...
    case DAMSoftContact3DTypes::
      ...
      break;
    case DAMSoftContact3DTypes::DAMSoftContact3DAugmentedFwdDynamics_Talos:
...
std::shared_ptr<
    force_feedback_mpc::softcontact::DAMSoftContact3DAugmentedFwdDynamics>
DAMSoftContact3DFactory::create_augmentedDAMSoft3D(
  ...
  std::shared_ptr<crocoddyl::ConstraintModelManager> constraint =
      std::make_shared<crocoddyl::ConstraintModelManager>(state,
                                                          actuation->get_nu());
