...
const std::vector<DAMSoftContact1DTypes::Type> DAMSoftContact1DTypes::all(
    DAMSoftContact1DTypes::init_all());
...
std::shared_ptr<
    force_feedback_mpc::softcontact::DAMSoftContact1DAugmentedFwdDynamics>
DAMSoftContact1DFactory::create_augmentedDAMSoft1D(
