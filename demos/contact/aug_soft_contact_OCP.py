...
config = load_yaml_file('/home/skleff/misc_repos/force_feedback_dgh/config/force_tracking_soft.yml')
...
problem = OptimalControlProblemSoftContactAugmented(robot, config).initialize(y0, softContactModel)
# Warmstart and solve
