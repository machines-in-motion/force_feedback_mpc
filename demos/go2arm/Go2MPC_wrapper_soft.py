...
from force_feedback_mpc.soft_mpc.soft_multicontact_api import ViscoElasticContact3d_Multiple, ViscoElasticContact3D
from force_feedback_mpc.soft_mpc.soft_multicontact_api import FrictionConeConstraint, ForceBoxConstraint, ForceConstraintManager
from force_feedback_mpc.soft_mpc.soft_multicontact_api import ForceCost, ForceCostManager, ForceRateCostManager
from force_feedback_mpc.soft_mpc.soft_multicontact_api import DAMSoftContactDynamics3D_Go2, IAMSoftContactDynamics3D_Go2
...
class Go2MPCSoft:
    ...
    def test_derivatives(self):
        ...
        TOL = 1e-2
        from force_feedback_mpc.soft_mpc.test_utils import get_fdot, \
                            get_iam_cost, \
                            get_xdot, \
                            get_ynext_y, \
                            get_dam_cost, \
                            get_cstr
        from force_feedback_mpc.soft_mpc.test_utils import numdiff, \
                            numdiff_q_dam_dyn, \
                            numdiff_u_iam_cost, \
                            numdiff_u_iam_dyn, \
                            numdiff_x_iam_cost, \
