...
for n_seed in range(N_SEEDS):
    for n_exp in range(N_EXP):
        torque_change_classical[n_seed, n_exp] = (
            data_2["torque_errors"][0][n_seed, n_exp]
            - data_1["torque_errors"][0][n_seed, n_exp]
        )
        torque_change_lpf[n_seed, n_exp] = (
            data_2["torque_errors"][1][n_seed, n_exp]
            - data_1["torque_errors"][1][n_seed, n_exp]
        )
        torque_change_soft[n_seed, n_exp] = (
            data_2["torque_errors"][2][n_seed, n_exp]
            - data_1["torque_errors"][2][n_seed, n_exp]
        )

        force_change_classical[n_seed, n_exp] = (
            data_2["force_errors_AVG"][0][n_seed, n_exp]
            - data_1["force_errors_AVG"][0][n_seed, n_exp]
        )
        force_change_lpf[n_seed, n_exp] = (
            data_2["force_errors_AVG"][1][n_seed, n_exp]
            - data_1["force_errors_AVG"][1][n_seed, n_exp]
        )
        force_change_soft[n_seed, n_exp] = (
            data_2["force_errors_AVG"][2][n_seed, n_exp]
            - data_1["force_errors_AVG"][2][n_seed, n_exp]
        )
...
print("--------")
print(
    "[WITH TORQUE CONTROL] Position MAE (classical) = ",
    np.mean(data_1["position_errors"][0]),
    "\u00b1",
    np.std(data_1["position_errors"][0]),
)
print(
    "[WITH TORQUE CONTROL] Position MAE (LPF)       = ",
    np.mean(data_1["position_errors"][1]),
    "\u00b1",
    np.std(data_1["position_errors"][1]),
)
print(
    "[WITH TORQUE CONTROL] Position MAE (soft)      = ",
    np.mean(data_1["position_errors"][2]),
    "\u00b1",
    np.std(data_1["position_errors"][2]),
)
print("----")
print(
    "[WITH TORQUE CONTROL] Force MAE (classical) = ",
    np.mean(data_1["force_errors_AVG"][0]),
    "\u00b1",
    np.std(data_1["force_errors_AVG"][0]),
)
print(
    "[WITH TORQUE CONTROL] Force MAE (LPF)       = ",
    np.mean(data_1["force_errors_AVG"][1]),
    "\u00b1",
    np.std(data_1["force_errors_AVG"][1]),
)
print(
    "[WITH TORQUE CONTROL] Force MAE (soft)      = ",
    np.mean(data_1["force_errors_AVG"][2]),
    "\u00b1",
    np.std(data_1["force_errors_AVG"][2]),
)
print("----")
print(
    "[WITH TORQUE CONTROL] Force Max. (classical) = ",
    np.max(data_1["force_errors_MAX"][0]),
)  # , u"\u00B1", np.std(data_1['force_errors_MAX'][0]))
print(
    "[WITH TORQUE CONTROL] Force Max. (LPF)       = ",
    np.max(data_1["force_errors_MAX"][1]),
)  # , u"\u00B1", np.std(data_1['force_errors_MAX'][1]))
print(
    "[WITH TORQUE CONTROL] Force Max. (soft)      = ",
    np.max(data_1["force_errors_MAX"][2]),
)  # , u"\u00B1", np.std(data_1['force_errors_MAX'][2]))
print("----")
print(
    "[WITH TORQUE CONTROL] Time not-in-contact (classical) = ",
    np.max(data_1["cycles_not_in_contact"][0]),
)  # , u"\u00B1", np.std(data_1['cycles_not_in_contact'][0]))
print(
    "[WITH TORQUE CONTROL] Time not-in-contact (LPF)       = ",
    np.max(data_1["cycles_not_in_contact"][1]),
)  # , u"\u00B1", np.std(data_1['cycles_not_in_contact'][1]))
print(
    "[WITH TORQUE CONTROL] Time not-in-contact (soft)      = ",
    np.max(data_1["cycles_not_in_contact"][2]),
)  # , u"\u00B1", np.std(data_1['cycles_not_in_contact'][2]))
print("--------")
print("--------")
...
print("--------")
print(
    "[NO TORQUE CONTROL] Position MAE (classical) = ",
    np.mean(data_2["position_errors"][0]),
    "\u00b1",
    np.std(data_2["position_errors"][0]),
)
print(
    "[NO TORQUE CONTROL] Position MAE (LPF)       = ",
    np.mean(data_2["position_errors"][1]),
    "\u00b1",
    np.std(data_2["position_errors"][1]),
)
print(
    "[NO TORQUE CONTROL] Position MAE (soft)      = ",
    np.mean(data_2["position_errors"][2]),
    "\u00b1",
    np.std(data_2["position_errors"][2]),
)
print("----")
print(
    "[NO TORQUE CONTROL] Force MAE (classical) = ",
    np.mean(data_2["force_errors_AVG"][0]),
    "\u00b1",
    np.std(data_2["force_errors_AVG"][0]),
)
print(
    "[NO TORQUE CONTROL] Force MAE (LPF)       = ",
    np.mean(data_2["force_errors_AVG"][1]),
    "\u00b1",
    np.std(data_2["force_errors_AVG"][1]),
)
print(
    "[NO TORQUE CONTROL] Force MAE (soft)      = ",
    np.mean(data_2["force_errors_AVG"][2]),
    "\u00b1",
    np.std(data_2["force_errors_AVG"][2]),
)
print("----")
print(
    "[NO TORQUE CONTROL] Force Max. (classical) = ",
    np.max(data_2["force_errors_MAX"][0]),
)  # , u"\u00B1", np.std(data_2['force_errors_MAX'][0]))
print(
    "[NO TORQUE CONTROL] Force Max. (LPF)       = ",
    np.max(data_2["force_errors_MAX"][1]),
)  # , u"\u00B1", np.std(data_2['force_errors_MAX'][1]))
print(
    "[NO TORQUE CONTROL] Force Max. (soft)      = ",
    np.max(data_2["force_errors_MAX"][2]),
)  # , u"\u00B1", np.std(data_2['force_errors_MAX'][2]))
print("----")
print(
    "[NO TORQUE CONTROL] Time not-in-contact (classical) = ",
    np.max(data_2["cycles_not_in_contact"][0]),
)  # , u"\u00B1", np.std(data_2['cycles_not_in_contact'][0]))
print(
    "[NO TORQUE CONTROL] Time not-in-contact (LPF)       = ",
    np.max(data_2["cycles_not_in_contact"][1]),
)  # , u"\u00B1", np.std(data_2['cycles_not_in_contact'][1]))
print(
    "[NO TORQUE CONTROL] Time not-in-contact (soft)      = ",
    np.max(data_2["cycles_not_in_contact"][2]),
)  # , u"\u00B1", np.std(data_2['cycles_not_in_contact'][2]))
print("--------")
print("--------")
...
print("--------")
print(
    " Force perf. change MAE (classical) = ",
    np.mean(force_change_classical_AVG),
    "\u00b1",
    np.std(force_change_classical_AVG),
)
print(
    " Force perf. change MAE (LPF)       = ",
    np.mean(force_change_lpf_AVG),
    "\u00b1",
    np.std(force_change_lpf_AVG),
)
print(
    " Force perf. change MAE (soft)      = ",
    np.mean(force_change_soft_AVG),
    "\u00b1",
    np.std(force_change_soft_AVG),
)
print("----")
print(
    " Torque perf. change (classical) = ",
    np.mean(torque_change_classical_AVG),
    "\u00b1",
    np.std(torque_change_classical_AVG),
)
print(
    " Torque perf. change (LPF)       = ",
    np.mean(torque_change_lpf_AVG),
    "\u00b1",
    np.std(torque_change_lpf_AVG),
)
print(
    " Torque perf. change (soft)      = ",
    np.mean(torque_change_soft_AVG),
    "\u00b1",
    np.std(torque_change_soft_AVG),
)
print("----")
print(
    " Perf. ratio (classical) = ",
    np.mean(force_change_classical_AVG / torque_change_classical_AVG),
    "\u00b1",
    np.std(force_change_classical_AVG / torque_change_classical_AVG),
)
print(
    " Perf. ratio (LPF)       = ",
    np.mean(force_change_lpf_AVG / torque_change_lpf_AVG),
    "\u00b1",
    np.std(force_change_lpf_AVG / torque_change_lpf_AVG),
)
print(
    " Perf. ratio (soft)      = ",
    np.mean(force_change_soft_AVG / torque_change_soft_AVG),
    "\u00b1",
    np.std(force_change_soft_AVG / torque_change_soft_AVG),
)
print("----")
print("--------")
print("--------")
