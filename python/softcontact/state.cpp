...
void exposeStateSoftContact() {
  ...
  bp::class_<StateSoftContact, bp::bases<crocoddyl::StateAbstract>>(
      ...
      .def("integrate", &StateSoftContact::integrate_x,
           bp::args("self", "x", "dx"),
      ...
      .def("Jdiff", &StateSoftContact::Jdiff_Js,
      ...
      .def("Jintegrate", &StateSoftContact::Jintegrate_Js,
      ...
      .def("JintegrateTransport", &StateSoftContact::JintegrateTransport,
