...
class Cone(object):
    def __init__(
        ...
        self.material = g.MeshPhongMaterial(
            color=0x00FF00, opacity=0.5, transparent=True, emissive=0x22AA22, side=2
        )

        self.circle_material = g.LineBasicMaterial(
            color=0xFFFFFF, linewidth=4, opacity=1.0
        )
    ...
    def _create_base_circle(self):
        ...
        self.base_circle.set_object(g.Line(geometry, self.circle_material))
