...
print(
    "  RMSE Fx-Fxdes = ",
    np.sum((measured_forces_dict1["Link6"][:, 0] - desired_forces[:, 0]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fy-Fydes = ",
    np.sum((measured_forces_dict1["Link6"][:, 1] - desired_forces[:, 1]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fz-Fzdes = ",
    np.sum((measured_forces_dict1["Link6"][:, 2] - desired_forces[:, 2]) ** 2, axis=0)
    / N_SIMU,
)
...
print(
    "  RMSE Fx-Fxdes = ",
    np.sum((measured_forces_dict2["Link6"][:, 0] - desired_forces[:, 0]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fy-Fydes = ",
    np.sum((measured_forces_dict2["Link6"][:, 1] - desired_forces[:, 1]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fz-Fzdes = ",
    np.sum((measured_forces_dict2["Link6"][:, 2] - desired_forces[:, 2]) ** 2, axis=0)
    / N_SIMU,
)
...
print(
    "  RMSE Fx-Fxdes = ",
    np.sum((measured_forces_dict3["Link6"][:, 0] - desired_forces[:, 0]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fy-Fydes = ",
    np.sum((measured_forces_dict3["Link6"][:, 1] - desired_forces[:, 1]) ** 2, axis=0)
    / N_SIMU,
)
print(
    "  RMSE Fz-Fzdes = ",
    np.sum((measured_forces_dict3["Link6"][:, 2] - desired_forces[:, 2]) ** 2, axis=0)
    / N_SIMU,
)
...
axs.plot(
    time_span,
    np.abs(measured_forces_dict1["Link6"][:, 0]),
...
axs.plot(
    time_span,
    np.abs(measured_forces_dict2["Link6"][:, 0]),
...
axs.plot(
    time_span,
    np.abs(measured_forces_dict3["Link6"][:, 0]),
