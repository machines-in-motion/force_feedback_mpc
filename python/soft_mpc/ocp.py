    ...
    def initialize(self, x0, softContactModel, callbacks=False):
        ...
        for i in range(self.N_h):
            ...
            runningModels.append(
                crocoddyl.IntegratedActionModelEuler(dam, stepTime=self.dt)
            )
            ...
            if "translation" in self.WHICH_COSTS:
                frameTranslationCost = self.create_frame_translation_cost(
                    state, actuation
                )
                runningModels[i].differential.costs.addCost(
            ...
            if "force" in self.WHICH_COSTS:
                ...
                runningModels[i].differential.set_force_cost(
                    forceRef, self.frameForceWeight
                )
        ...
        terminalModel = crocoddyl.IntegratedActionModelEuler(dam_t, stepTime=0.0)
